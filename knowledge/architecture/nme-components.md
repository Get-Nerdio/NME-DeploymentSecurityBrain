...
status: reviewed
sources: [_meta/sources.md#reference-architecture, _meta/sources.md#implementation-guide, _meta/sources.md#api-permissions-xlsx, _meta/sources.md#release-notes, _meta/sources.md#nw-se-automation-aa-2026-06-15, _meta/sources.md#arm-template-77]
...
> The **Initial SKU / size** column is observed from the **7.7** ARM template
> ([_meta/sources.md#arm-template-77]); these defaults are expected to carry to 8.0 but are
> **not yet re-verified against an 8.0 template**. The resource *list* itself is unchanged.

| Resource | Role | Initial SKU / size (7.7 ARM defaults) |
|---|---|---|
...
resources. ([_meta/sources.md#arm-template-77])
...
them, SQL gets an `AllowAllWindowsAzureIps` (0.0.0.0) firewall rule. ([_meta/sources.md#arm-template-77])
